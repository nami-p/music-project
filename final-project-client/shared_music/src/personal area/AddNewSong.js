...
import Search from "./GenerateImages";
...
const AddNewSong = () => {
    ...
    const setIsSearch=(boolean)=>{
         setSearchImage(boolean);
    }
     const setTheSrc=(newSrc)=>{
        setImageSrc(newSrc);
     }
    ...
    const handleSave = (e) => {
        ...
        if (!currSong.FileImage) {
            if (imageSrc === '')
                ...
                setCurrSong((prevSong) => ({ ...prevSong, Image: imageSrc }))
        }
        // if (!currSong.FileImage) {
        //     toDataURL(url)
        //         .then(dataUrl => {
    ...
    return (<>
                ...
                <div className="modal-container page">
                    <div className="modal-left">
                        ...
                        <div className="modal-buttons">
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'auto auto auto auto', margin: '5px' }}>
                                <div>
                            ...
                            <Tooltip title="generate image">
                                <Button component="span" variant="contained" startIcon={<ImageSearchIcon />} style={{ backgroundColor: 'secondary.main' }} onClick={() =>
        ...
        {searchImage&&<Search setImageSrc={setTheSrc} setSearchImage={setIsSearch}/>}
    </>);
}
